      ...
      (
        ...
        return (
          ...
          >
            ...
            <div className="pointer-events-none absolute left-full top-0 z-[200] ml-2 w-60 translate-x-1 rounded-xl border border-slate-700 bg-slate-950 p-2 opacity-0 shadow-2xl shadow-black/40 transition-all group-hover:pointer-events-auto group-hover:translate-x-0 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-x-0 group-focus-within:opacity-100">
