...
assert.equal(find('USR-000004')['Target Tahunan'], '108266190934');
assert.equal(find('USR-000003')['Target Tahunan'], '109266190934');
assert.equal(find('USR-000001')['Target Tahunan'], '109266190934');
