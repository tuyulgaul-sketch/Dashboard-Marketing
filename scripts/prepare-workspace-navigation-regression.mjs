...
// Extend the old source-integrity test only. The production upload hub and
// authorization implementation are never rewritten by this preparation.
...
console.log('Historical navigation fixture extended for approved wizard and auth continuity; runtime source unchanged.');
