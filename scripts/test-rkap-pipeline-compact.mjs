...
assert.equal(parsedBook.worksheets[1].getRow(2).values[1],'USR-100001');
assert.equal(parsedBook.worksheets[1].getRow(3).values[7],'Advisor');
assert.equal(parsedBook.worksheets[1].getRow(8).values[1],undefined);
